        ...
        <Router>
          <Navbar/>
            <Routes>
              ...
              <Route exact path='/entertainment' element={<News key="ebtertainment" pageSize={9} country="in" category="ebtertainment"/>}></Route>
              ...
              <Route exact path='/sport' element={<News key="sport" pageSize={9} country="in" category="sport"/>}></Route>
